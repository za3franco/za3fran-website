...
export const DISPLAY_PRICES = {
  ...
  // ── Menu Engineer (Phase 5) ─────────────────────────────────
  // Returning Validator customer, standalone Menu Engineer
  menu: {
    EUR: '€399',
    MAD: 'MAD 3 990',
    USD: '$449',
  },
  // Returning Validator + BP customer — loyalty rate
  menu_loyalty: {
    EUR: '€349',
    MAD: 'MAD 3 490',
    USD: '$389',
  },
  // Additional regeneration beyond the 1 free included
  menu_regen: {
    EUR: '€49',
    MAD: 'MAD 490',
    USD: '$54',
  },
  // New user — Validator + Menu Engineer bundle
  bundle_menu: {
    EUR: '€499',
    MAD: 'MAD 4 990',
    USD: '$549',
  },
  // New user — Validator + BP Essentials + Menu Engineer bundle
  bundle_full: {
    EUR: '€849',
    MAD: 'MAD 8 490',
    USD: '$949',
...
export const STRIPE_PRICES = {
  ...
  // ── Menu Engineer (Phase 5) ─────────────────────────────────
  // Returning Validator customer, standalone Menu Engineer — €399
  menu: {
    EUR: process.env.STRIPE_PRICE_MENU_EUR,
    MAD: process.env.STRIPE_PRICE_MENU_MAD,
    USD: process.env.STRIPE_PRICE_MENU_USD,
  },
  // Returning Validator + BP customer — loyalty rate €349
  menu_loyalty: {
    EUR: process.env.STRIPE_PRICE_MENU_LOYALTY_EUR,
    MAD: process.env.STRIPE_PRICE_MENU_LOYALTY_MAD,
    USD: process.env.STRIPE_PRICE_MENU_LOYALTY_USD,
  },
  // Additional regeneration beyond the 1 free included — €49
  menu_regen: {
    EUR: process.env.STRIPE_PRICE_MENU_REGEN_EUR,
    MAD: process.env.STRIPE_PRICE_MENU_REGEN_MAD,
    USD: process.env.STRIPE_PRICE_MENU_REGEN_USD,
  },
  // New user — Validator + Menu Engineer bundle — €499
  bundle_menu: {
    EUR: process.env.STRIPE_PRICE_BUNDLE_MENU_EUR,
    MAD: process.env.STRIPE_PRICE_BUNDLE_MENU_MAD,
    USD: process.env.STRIPE_PRICE_BUNDLE_MENU_USD,
  },
  // New user — Validator + BP Essentials + Menu Engineer bundle — €849
  bundle_full: {
    EUR: process.env.STRIPE_PRICE_BUNDLE_FULL_EUR,
    MAD: process.env.STRIPE_PRICE_BUNDLE_FULL_MAD,
    USD: process.env.STRIPE_PRICE_BUNDLE_FULL_USD,
  },
};
