...
function buildPrompt(c) {
  ...
  var printCSS = '@media print { section { page-break-before: auto; page-break-inside: auto; } .cover-section { page-break-before: always; page-break-after: always; } .financial-section { page-break-before: always; } table { page-break-inside: avoid; } tr { page-break-inside: avoid; } h2, h3, h4 { page-break-after: avoid; } p { orphans: 3; widows: 3; } .estimate-box, .risk-block, .za3fran-box { page-break-inside: avoid; } }';
