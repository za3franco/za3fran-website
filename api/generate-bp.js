...
function buildPrompt(c) {
  ...
  var design = fr
    ? 'DESIGN HTML: Document HTML COMPLET auto-contenu. Google Fonts: Cormorant Garamond (titres) + DM Sans (corps). Background #FAFAF7, texte #1a1a1a, accent #C9862A, navy #0F1F3D. Page couverture: fond #0a0a0a. Tableaux: bordures #e8e8e4, rangees alternees, en-tetes #0F1F3D blanc. Encadres ESTIMATION DIRECTIONNELLE: fond #fff8f0, bordure gauche 3px #C9862A. Encadre Za3fran: fond #0F1F3D texte blanc. Max-width 860px. @media print: page-break-before chaque section. Rendu impeccable, professionnel.'
    : 'HTML DESIGN: Complete self-contained HTML document. Google Fonts: Cormorant Garamond (headings) + DM Sans (body). Background #FAFAF7, text #1a1a1a, accent #C9862A, navy #0F1F3D. Cover: #0a0a0a background. Tables: #e8e8e4 borders, alternating rows, #0F1F3D white headers. DIRECTIONAL ESTIMATE boxes: #fff8f0 background, 3px #C9862A left border. Za3fran box: #0F1F3D background white text. Max-width 860px. @media print: page-break-before each section. Impeccable, professional rendering.';
